...
{
    public class MyUserManager : UserManager<AspNetUser, string>
    {
        public MyUserManager(IUserStore<AspNetUser> store)
            : base(store)
        {
        }
        ...
        {
            var manager = new MyUserManager(new UserStore<AspNetUser>(context.Get<ApplicationDbContext>()));
